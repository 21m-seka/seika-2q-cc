...
document.getElementById("icon").onclick = asd;
...
function tub1 () {
	...
	if (tub1.classList.contains("tub-unactive")) {
...
function tub2() {
	...
	if (tub2.classList.contains('tub-unactive')) {
